...
public class Robot {
	...
	private ArrayList<Direction> lstDirection=new ArrayList<>();
	
	public ArrayList<Direction> getLstDirection() {
		return lstDirection;
	}
...
//		printRoute();
		...
		if (this.getNextAction() == 1) {
			...
			if (this.maze.isWall(this.xPosition, this.yPosition) == true) {
				...
				if (currentX != this.xPosition || currentY != this.yPosition) {
					...
					this.lstDirection.add(this.heading);
				}
			}
		}
		// Move clockwise
	...
	public String printSensorActions(){
		
		StringBuilder builder = new StringBuilder();
		
		StringBuilder builderTraza = new StringBuilder();
		
		for(int i=0; i < this.sensorActions.length; i++){
			
			builder.append(this.sensorActions[i]).append(",");
			
			switch (this.sensorActions[i]) {
			case 0:
				
				builderTraza.append("0").append(",");
				
				break;
			case 1:
				builderTraza.append("F").append(",");
				break;	
			
			case 2:
				builderTraza.append("L").append(",");
				break;				
			case 3:
				builderTraza.append("R").append(",");
				break;	

			default:
				builderTraza.append("x").append(",");
				break;
			}
		...
		builder.append("\n");
		builder.append(builderTraza.toString());
